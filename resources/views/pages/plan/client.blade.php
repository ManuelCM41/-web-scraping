                ...
                <div class="grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 gap-2">
                    ...
                    <div>
                        <div class="bg-white px-6 py-3 rounded-lg">
                            <span class="font-extrabold text-xl ">Identificación del Cliente</span>
                            <div class="mt-2 ">
                                <span>Solicitamos únicamente la información esencial para la finalización de la
                                    compra.</span>
                            </div>
                            <div class="flex items-center">
                                <form autocomplete="off" class="padre w-full max-w-lg">
                                    ...
                                    <div class="flex flex-wrap -mx-3 mt-6">
                                        <div class="w-full md:w-12/12 px-3 md:mb-0">
                                            ...
                                            @if (empty($client['email']))
                                                <x-input-error for="client.email">Email es obligatorio.</x-input-error>
                                            @elseif (!filter_var($client['email'], FILTER_VALIDATE_EMAIL))
                                                <x-input-error for="client.email">*Correo electrónico no
                                                    válido.</x-input-error>
                                            @endif
                                        </div>
                                        ...
                                        <div class="w-full md:w-12/12 px-3 md:mb-0">
                                            ...
                                            <input wire:model="client.name"
                                                class="appearance-none block w-full rounded-lg text-black border border-gray-400 py-2 px-2 mb-3 leading-tight focus:outline-none focus:bg-white"
                                                type="text" @if ($readOnly) readonly @endif>
                                            @if ($readOnly)
                                        ...
                                        <div class="flex">
                                            <div class="w-full md:w-12/12 px-3 md:mb-0">
                                                ...
                                                <input wire:model="client.paterno"
                                                    class="appearance-none block w-full rounded-lg text-black border border-gray-400 py-2 px-2 mb-3 leading-tight focus:outline-none focus:bg-white"
                                                    type="text" @if ($readOnly) readonly @endif>
                                                @if ($readOnly)
                                                    <x-input-error for="client.paterno" />
                                                @endif
                                            </div>
                                            <div class="w-full md:w-12/12 px-3 md:mb-0">
                                                <label class="">
                                                ...
                                                <input wire:model="client.materno"
                                                    class="appearance-none block w-full rounded-lg text-black border border-gray-400 py-2 px-2 mb-3 leading-tight focus:outline-none focus:bg-white"
                                                    type="text" @if ($readOnly) readonly @endif>
                                                @if ($readOnly)
                                                    <x-input-error for="client.materno" />
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="w-full md:w-12/12 md:mb-0 mt-5">
                                        ...
                                        @unless (!empty($client['tdatos']))
                                            <x-input-error for="client.tdatos" />
                                        @endunless
                                    </div>
                                </form>
                            </div>
